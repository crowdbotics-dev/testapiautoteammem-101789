...
## Project Structure
    ...
    ├── testapiautoteammem_101789  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_101789`
...
2. Clone this repo and `cd testapiautoteammem_101789`
